...
class LNNModle(object):
    ...
    def model(self,X,y,layers_dim,num_iters=500,learning_rate=0.001,print_cost=True):
        """
        整合到一起，网络模型
        :param X: 训练数据
        :param y: 训练数据标签
...
if __name__ == '__main__':
    ...
    model = LNNModle()
    parameters,_ = model.model(train_X, train_Y, layers_dims, num_iters=500,learning_rate=0.001, print_cost=True)
